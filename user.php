...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitUserForm" action="php/createUser.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="rupassword" class="col-sm-3 control-label">Re-Enter Password: </label>
	        	
				    <div class="col-sm-8">
				      <input type="password" class="form-control" id="rupassword" placeholder="RPassword" name="rupassword" autocomplete="off" required="true">
				    </div>
	        </div> <!-- /form-group-->	        	 
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="userInfo">
				    	<form class="form-horizontal" id="editUserForm" action="php/editUser.php" method="POST">				    
				    	<br />
