	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Suppliers</div>
			</div> <!-- /panel-heading -->
...
<div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php/createSupplier.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="supph" class="col-sm-3 control-label">Supplier Contact: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="supph" placeholder="Supplier contact" name="supph" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	        <div class="form-group">
	        	<label for="supph" class="col-sm-3 control-label">Supplier Address: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="supadd" placeholder="Supplier address" name="supadd" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
...
<div class="modal fade" id="editBrandModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php/editSupplier.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		        ...
		        <div class="form-group">
	        	<label for="editsupph" class="col-sm-3 control-label">Supplier Contact: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="editsupph" placeholder="Supplier contact" name="editsupph" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	        <div class="form-group">
	        	<label for="editsupph" class="col-sm-3 control-label">Supplier Address: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="editsupadd" placeholder="Supplier address" name="editsupadd" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
