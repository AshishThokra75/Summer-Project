				  ...
				  <div class="tab-content">
			       ...
			       <!-- QTY. IN -->
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="inQuantity" placeholder="Quantity-In" name="inQuantity" autocomplete="off" min="0" >
						    </div>
			        </div> <!-- /form-group-->	
			        ...
			        <div class="form-group"><!-- Item Out -->
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="outQuantity" placeholder="Quantity Out" name="outQuantity" autocomplete="off" min="0">
						    </div>
			        </div> <!-- /form-group-->        	 
...
<script src="custom/js/farmstore.js"></script>
