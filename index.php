...
if(isset($_SESSION['userId'])) {
  header('location:'.$farm_url.'dashboard.php');    
}
...
<head>
  ...
  <link rel="stylesheet" href="custom/css/login2.css">
...
<form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm">
  ...
  <div class="form-check">
      <center><button type="submit" class="btn btn-default"> <i class="glyphicon glyphicon-log-in"></i> Sign in</button></center>
  </div>
